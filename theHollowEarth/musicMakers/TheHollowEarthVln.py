...
## Section 1 / 7 %% Bar 1
Tail = TailTones[0]
FifthPartial = FndFifthPartial[0]
Fundamental = Fundamentals[0]

# Green
phrase = ""
phrase = GreenPedal.format(Fundamental+Dreigestr)
print(phrase)
...
phrase = PermTwoSlow.format(FifthPartial+Eingestr,Middle+Zweigestr,Tail+Zweigestr)
print(phrase)
...
phrase = PermTwoSlow.format(FifthPartial+Zweigestr,Middle+Dreigestr,Tail+Dreigestr)
print(phrase)

phrase = ""
Middle = MelodyTones[5]
phrase = PermThreeSlow.format(FifthPartial+Zweigestr,Middle+Dreigestr,Tail+Dreigestr)
print(phrase)

FifthPartial = FndFifthPartial[1]
...
phrase = PermFourSlow.format(FifthPartial+Dreigestr,Middle+Zweigestr,Tail+Zweigestr)
print(phrase)
...
phrase = PermFourSlow.format(FifthPartial+Dreigestr,Middle+Dreigestr,Tail+Dreigestr)
print(phrase)
...
FifthPartial = FndFifthPartial[2]
Fundamental = Fundamentals[2] # as

# Red/Green
phrase = ""
Middle = MelodyTones[10]
phrase = PermFiveSlow.format(FifthPartial+Zweigestr,Middle+Zweigestr,Tail+Zweigestr)
print(phrase)
...
phrase = PermOneSlow.format(FifthPartial+Zweigestr,Middle+Zweigestr,Tail+Zweigestr)
print(phrase)
...
phrase = PermTwoSlow.format(FifthPartial+Zweigestr,Middle+Dreigestr,Tail+Zweigestr)
print(phrase)
...
## Section 5 / 7 
Tail = TailTones[4]
FifthPartial = FndFifthPartial[3]
...
phrase = PermTwoSlow.format(FifthPartial+Dreigestr,Middle+Dreigestr,Tail+Dreigestr)
print(phrase)
...
phrase = PermOneSlow.format(FifthPartial+Zweigestr,Middle+Eingestr,Tail+Eingestr)
print(phrase)

# Red
phrase = ""
Middle = MelodyTones[23]
phrase = PermTwoSlow.format(FifthPartial+Zweigestr,Middle+Zweigestr,Tail+Zweigestr)
print(phrase)
...
## Section 7 / 7 
Tail = TailTones[6]
FifthPartial = FndFifthPartial[4]
...
phrase = PermFiveSlow.format(FifthPartial+Eingestr,Middle+Eingestr,Tail+Eingestr)
print(phrase)
